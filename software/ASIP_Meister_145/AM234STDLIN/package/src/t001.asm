...
br_t:
br_pa:	JP		$(br0 - br_pa - 4)		; enter br maze
br_abt:	TRAP	$(trap_abort - trap_base)
br0:	LSOI	%GPR10,	%GPR10,	$(0x0000)
	LSOI	%GPR10,	%GPR10,	$(0x1111)
br1:	BRZ	%GPR0,	$(br2 - br1 - 4)
	TRAP	$(trap_abort - trap_base)
br2:	BRZ	%GPR10,	$(br_abt - br2 - 4)
br3:	BRNZ	%GPR0,	$(br_abt - br3 - 4)
br4:	BRNZ	%GPR10,	$(br5 - br4 - 4)
		TRAP	$(trap_abort - trap_base)
br5:	NOP						; clear
	; OK, go to the next test
...
jpl_t:
	...
	LSOI	%GPR10,	%GPR10,	$(jpl1 % 0x10000)
	ADDI	%GPR10,	%GPR10,	$(4)
jpl1:	JPL	$(jpl2 - jpl1 - 4)
	TRAP	$(trap_abort - trap_base)
jpl2:	EEQ	%GPR11,	%GPR10,	%GPR3			; check saved value
jpl3:	BRNZ	%GPR11, $(jpl4 - jpl3 - 4)
...
jprl1:	JPRL	%GPR11
	TRAP	$(trap_abort - trap_base)
jprl2:	EEQ	%GPR12, %GPR10, %GPR3			; check saved value
jprl3:	BRNZ	%GPR12, $(jprl4 - jprl3 - 4)
	TRAP	$(trap_abort - trap_base)		; trapped
jprl4:	NOP						; clear
	; OK, go to the next test
